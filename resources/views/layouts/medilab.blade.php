...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-between">
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">zhyyevo@gmail.com</a>
                <i class="bi bi-phone"></i> <a href="https://wa.me/0819-1736-1646">+62 819-1736-1646</a>
            </div>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="/login" class="appointment-btn scrollto"><span class="d-none d-md-inline">Login </span>Admin</a>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            ...
            <h2>"Jangan tunggu besok untuk memulai, mari mulai hari ini dengan langkah kecil menuju hidup yang lebih sehat. Kita dapat melakukan ini bersama!"</h2>
            <a href="#appointment" class="btn-get-started scrollto">Register Pasien</a>
        </div>
    </section><!-- End Hero -->
        ...
        <section id="contact" class="contact">
            ...
            <div>
                <iframe style="border:0; width: 100%; height: 350px;"
                    src="https://www.google.com/maps/@-8.6812589,116.2468886,41807m/data=!3m1!1e3?hl=en-US&entry=ttu"
                    ...
                    <div class="col-lg-4">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Central Lombok Regency, West Nusa</p>
                            </div>
